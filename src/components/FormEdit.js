    ...
    <form action={addReview}>
      ...
      <div className="mb-3">
        ...
        <input
          ...
          id="read"
          name="read"
          className="block bg-gray-100 border-2 border-gray-600 rounded forcus:bg-white forcus:outline-none focus:border-red-500"
          defaultValue={read}
        />
      </div>
      <div className="mb-3">
        ...
        <textarea
          ...
          name="memo"
          rows="3"
          className="block bg-gray-100 border-2 border-gray-600 w-full rounded forcus:bg-white forcus:outline-none focus:border-red-500"
          defaultValue={memo}
        ></textarea>
      </div>
      <button
